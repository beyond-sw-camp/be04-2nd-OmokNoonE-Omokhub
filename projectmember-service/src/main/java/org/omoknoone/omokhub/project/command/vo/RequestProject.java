...
public class RequestProject {
    ...
    public RequestProject(int projectId, String title, LocalDateTime startDate, LocalDateTime endDate, LocalDateTime lastModifiedDate, String status, int projectTeamId, int projectMemberId, boolean isPublic) {
