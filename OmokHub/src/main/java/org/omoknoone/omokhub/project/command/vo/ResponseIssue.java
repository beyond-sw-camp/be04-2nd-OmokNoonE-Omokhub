...
public class ResponseIssue {
    ...
    public ResponseIssue(int issueId, String title, String content, boolean isClosed, LocalDateTime postedDate, LocalDateTime closedDate, LocalDateTime lastModifiedDate, int projectMemberId, int projectId) {
